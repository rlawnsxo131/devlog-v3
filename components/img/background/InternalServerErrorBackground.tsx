...
function InternalServerErrorBackground(props: Props) {
  return (
    ...
    >
      <defs>
        <linearGradient
          id="af83dc26-9572-4816-b7a1-1af4f72ff554-72"
          x1="678.2"
          y1="821.79"
          x2="678.2"
          y2="493.4"
      ...
      <g opacity="0.1">
        ...
        <path
          ...
          opacity="0.1"
        />
        <circle cx="925.49" cy="102.72" r="10.69" fill="#0894b4" />
        <circle cx="987.93" cy="109.58" r="10.69" fill="#0894b4" />
        <circle cx="1012.01" cy="205.64" r="10.69" fill="#0894b4" />
        <circle cx="979.51" cy="253.61" r="10.69" fill="#0894b4" />
        <circle cx="935.11" cy="353.24" r="10.69" fill="#0894b4" />
        <circle cx="935.11" cy="353.24" r="10.69" opacity="0.1" />
        <circle cx="836.39" cy="240.4" r="10.69" fill="#0894b4" />
      ...
      <g opacity="0.1">
        ...
        <path
          ...
          opacity="0.1"
        />
        <circle cx="48.97" cy="324.78" r="5.39" fill="#0894b4" />
        <circle cx="17.51" cy="328.24" r="5.39" fill="#0894b4" />
        <circle cx="5.39" cy="376.63" r="5.39" fill="#0894b4" />
        <circle cx="21.76" cy="400.8" r="5.39" fill="#0894b4" />
        <circle cx="44.12" cy="450.99" r="5.39" fill="#0894b4" />
        <circle cx="44.12" cy="450.99" r="5.39" opacity="0.1" />
        <circle cx="93.85" cy="394.14" r="5.39" fill="#0894b4" />
      ...
      <path
        ...
        transform="translate(-88.65 -57.09)"
        fill="url(#af83dc26-9572-4816-b7a1-1af4f72ff554-72)"
      />
      <path
      ...
      <ellipse cx="813.11" cy="655.78" rx="32.29" ry="6.21" fill="#0894b4" />
      ...
      <path
        ...
        opacity="0.1"
      />
      <ellipse cx="148.42" cy="776.87" rx="46.49" ry="8.94" fill="#0894b4" />
